...
export const googleSheetSchema = [
  ...
  'Which pass will this event submitted under?',
  'Which token number will you be using?',
  ...
  'Which team/community will this event be associated with?',
  'If this is a collab event, who will be handling the logistics?',
  'Is this an ACM General Event?',
];
